...
const Branch: React.FC = () => {
  ...
  return (
    <motion.div 
      className="min-h-screen relative px-5"
      initial={{ opacity: 0 }}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {Object.entries(branchData).map(([id, branch], index) => (
            <motion.div 
              key={id} 
              className="backdrop-blur-md bg-white/10 rounded-lg shadow-xl p-10 transform hover:scale-[1.02]"
            ...
            >
              <motion.div 
                className="relative h-64 mb-8 overflow-hidden rounded-lg"
